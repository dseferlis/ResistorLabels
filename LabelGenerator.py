...
HERMA_44 = PaperConfig(
    paper_name="HERMA 44",
    pagesize=A4,
    sticker_width=48 * mm,
    sticker_height=25 * mm,
    sticker_corner_radius=0 * mm,
    left_margin=8 * mm,
    top_margin=9 * mm,
    horizontal_stride=48 * mm,
    vertical_stride=25 * mm,
    num_stickers_horizontal=4,
    num_stickers_vertical=11,
)

HERMA_4461 = PaperConfig(
    paper_name="HERMA 4461",
    pagesize=A4,
    sticker_width=52.5 * mm,
    sticker_height=29.7 * mm,
    sticker_corner_radius=0 * mm,
    left_margin=0.5 * mm,
    top_margin=0.5 * mm,
    horizontal_stride=52.5 * mm,
    vertical_stride=29.7 * mm,
    num_stickers_horizontal=4,
    num_stickers_vertical=10,
)
...
TL_3311 = PaperConfig(
    ...
    pagesize=A4,
    sticker_width=65 * mm,
    sticker_height=25.4 * mm,
    sticker_corner_radius=0 * mm,
    left_margin=2 * mm,
    top_margin=9 * mm,
    horizontal_stride=69 * mm,
...
def main() -> None:
    ...
    # ############################################################################
    resistor_values: ResistorList = [ 0, 0.01 ] + generate_values(E24_ALL_VALUES, 0, 6)
